...
SQLite - DCL
•테이블 생성
sqlite>create table phonebook (name char(32), phone char(32),
email char(64) primary key); sqlite> .schema phonebook
•테이블 삭제
...
데이터 수정
sqlite>update phonebook set phone='010-5555-5555', email =
'python@python.com'
where name='강감찬';

•데이터 삭제
•sqlite>delete from phonebook
where email='python@python.com';
